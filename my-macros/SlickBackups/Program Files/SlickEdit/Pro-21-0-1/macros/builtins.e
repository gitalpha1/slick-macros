 ...
 * @categories Editor_Control_Properties, Edit_Window_Properties
 */
boolean p_spell_check_while_typing,
...
int _copy_objects_to_clipboard(boolean isClipboard=true),
    _sc_lang_control::_copy_objects_to_clipboard(boolean isClipboard=true);
 ...
 */
int _copy_from_clipboard(boolean isClipboard=true,boolean binary=false),
    _sc_lang_text_window::_copy_from_clipboard(boolean isClipboard=true,boolean binary=false);
 ...
 *
 */
void mou_capture(boolean grabMouse=true);
 ...
 */
boolean _BlockSelStartAndEndSimilar(_str mark_id="",boolean return_true_if_one_character_width=false),
        _sc_lang_editor::_BlockSelStartAndEndSimilar(_str mark_id="",boolean return_true_if_one_character_width=false);
 ...
 *
 */
int _join_line(boolean stripLeadingSpaces=false),
    _sc_lang_editor::_join_line(boolean stripLeadingSpaces=false);
 ...
 *
 */
int _JoinLineToCursor(boolean stripLeadingSpaces=false),
    _sc_lang_editor::_JoinLineToCursor(boolean stripLeadingSpaces=false);
...
void _insert_text(_str string,boolean binary=false,_str newlineChars="\r\n"),
     _sc_lang_editor::_insert_text(_str string,boolean binary=false,_str newlineChars="\r\n");
...
void _replace_text(long delLen,_str string,_str flags='',_str newlineChars="\r\n"),
     _sc_lang_editor::_replace_text(long delLen,_str string,_str option='',boolean binary=false,_str newlineChars="\r\n");
...
void _insert_text_raw(_str string,boolean binary=false,_str newlineChars="\r\n"),
     _sc_lang_editor::_insert_text_raw(_str string,boolean binary=false,_str newlineChars="\r\n");
...
int _line_length(boolean includeNLChars=false),
    _sc_lang_editor::_line_length(boolean includeNLChars=false);
 ...
 */
int _copy_to_clipboard(_str markid="",boolean isClipboard=true,boolean addClipboard=false,int isMultiCursorClipboard=-1,int MarkFlags= -1),
    _sc_lang_editor::_copy_to_clipboard(_str markid="",boolean isClipboard=true,boolean addClipboard=false,int isMultiCursorClipboard=-1,int MarkFlags= -1);
 ...
 */
int _begin_select(_str markid="",boolean LockSelection=true,boolean RestoreScrollPos=true,int beginPivot=0),
    _sc_lang_editor::_begin_select(_str markid="",boolean LockSelection=true,boolean RestoreScrollPos=true,int beginPivot=0);
 ...
 * @categories Edit_Window_Methods, Editor_Control_Methods, Selection_Functions
 */
int _end_select(_str markid="",boolean LockSelection=true,boolean RestoreScrollPos=true,boolean endPivot=false),
    _sc_lang_editor::_end_select(_str markid="",boolean LockSelection=true,boolean RestoreScrollPos=true,boolean endPivot=false);
...
int up(int Noflines=1,boolean doScreenLines=false),
    _sc_lang_editor::up(int Noflines=1,boolean doScreenLines=false);
...
int down(int Noflines=1,boolean doScreenLines=false),
    _sc_lang_editor::down(int Noflines=1,boolean doScreenLines=false);
 ...
 * returned if that tagged expression was not found. For Perl regular expressions,
...
boolean past_end_of_line(boolean moveToEndIfPast = false),
    _sc_lang_editor::past_end_of_line(boolean moveToEndIfPast = false);
...
int _BufLoad(_str filename,_str options=null,boolean CreateIfNotFound=true,int &BLResultFlags=0),
    _sc_lang_editor::_BufLoad(_str filename,_str options=null,boolean CreateIfNotFound=true,int &BLResultFlags=0);
...
void _setEnabled(int tabIndex, boolean enabled),
     _sc_lang_sstab::_setEnabled(int tabIndex, boolean enabled);
 ...
 * @categories File_Functions
 */
boolean _file_eq(_str file1, _str file2);
 ...
 * For Perl regular expressions, the first tagged expression is 1. 0
 ...
 *
 */
_str _scroll_style(_str newScrollStyle=null,boolean store_new_setting=true),
     _sc_lang_editor::_scroll_style(_str newScrollStyle=null,boolean store_new_setting=true);
 ...
 * @categories File_Functions
 */
_str absolute(_str filename,_str toDir=null,boolean resolveSymLinks=false);
/**
...
int _SetTextColor(int ColorIndex, int Nofbytes,boolean replacePreviousColor=true),
    _sc_lang_editor::_SetTextColor(int ColorIndex, int Nofbytes,boolean replacePreviousColor=true);
...
int _TreeAddItem(int ItemIndex, _str caption,
    ...
    _sc_lang_tree_view::_TreeAddItem(int ItemIndex, _str caption,
                             int flags=0, int NonCurrentBMIndex=0,
                             int CurrentBMIndex=0, int ShowChildren=TREE_NODE_EXPANDED,
                             int moreFlags=0, typeless userInfo=0);
...
void _TreeSortCaption(int ItemIndex,_str PrimarySortOptions="",_str SecondarySortOptions=""),
    _sc_lang_tree_view::_TreeSortCaption(int ItemIndex,_str PrimarySortOptions="",_str SecondarySortOptions="");
...
typeless lbutton_double_click(),
         _sc_lang_control::lbutton_double_click();
...
typeless lbutton_triple_click(),
         _sc_lang_control::lbutton_triple_click();
 ...
 */
event on_drop_down(),
      _sc_lang_combo_box::on_drop_down();
...
event on_hsb_line_down(),
    _sc_lang_editor::on_hsb_line_down();
...
event on_hsb_line_up(),
    _sc_lang_editor::on_hsb_line_up();
...
event on_hsb_page_down(),
    _sc_lang_editor::on_hsb_page_down();
...
event on_hsb_page_up(),
    _sc_lang_editor::on_hsb_page_up();
...
event on_hsb_thumb_pos(),
    _sc_lang_editor::on_hsb_thumb_pos();
...
event on_hsb_thumb_track(),
    _sc_lang_editor::on_hsb_thumb_track();
 ...
 */
event on_lost_focus(),
    _sc_lang_control::on_lost_focus();
...
event on_scroll_lock(),
    _sc_lang_scrollable::on_scroll_lock();
...
event on_vsb_line_down(),
    _sc_lang_editor::on_vsb_line_down();
...
event on_vsb_line_up(),
    _sc_lang_editor::on_vsb_line_up();
...
event on_vsb_page_down(),
    _sc_lang_editor::on_vsb_page_down();
...
event on_vsb_page_up(),
    _sc_lang_editor::on_vsb_page_up();
...
event on_vsb_thumb_pos(),
    _sc_lang_editor::on_vsb_thumb_pos();
...
event on_vsb_thumb_track(),
    _sc_lang_editor::on_vsb_thumb_track();
...
event rbutton_double_click(),
    _sc_lang_control::rbutton_double_click();
...
event rbutton_triple_click(),
    _sc_lang_control::rbutton_triple_click();
...
boolean _haveBuild();
boolean _haveDebugging();
boolean _haveContextTagging();
boolean _haveVersionControl();
boolean _haveProMacros();
boolean _haveBeautifiers();
boolean _haveRefactoring();
boolean _haveRealTimeErrors();
boolean _haveProDiff();
boolean _haveMerge();

/**
 * @return true if current operating system is macOS
 *         compatible.
 */
boolean _isMac();
/**
...
boolean _isUnix();
/**
 * @return true if current operating system is Microsoft Windows
 *         compatible.
 */
boolean _isWindows();
