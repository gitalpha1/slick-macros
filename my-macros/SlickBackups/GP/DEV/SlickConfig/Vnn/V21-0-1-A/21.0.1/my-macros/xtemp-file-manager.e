...
// change TEMP_FILES_PATH as needed. Remember to include a file separator at the end and you
// must also use the correct file separator for your OS. e.g. backslash for Windows. Forward slash
// doesn't work on Windows because I'm too lazy to make the code translate it.  Use single quotes. e.g.
//
// #define TEMP_FILES_PATH 'C:\Users\GP\xtemporary_files' :+ FILESEP
// 
// 
...
// however, this doesn't always work !!!!!!!!!  After a "module load" operation, it's best to re-start slick.
// 
...
static int        xtemp_list_maintain_timer;
...
#define XTEMP_FILE_LIST_FILENAME  TEMP_FILES_PATH :+ 'AA_xtemporary_file_list.txt'
...
void _workspace_opened_handle_xtemp_files()
{
   ...
   xtemp_remember_first_file = p_buf_name;
